...
export default function NutritionistProfile() {
  ...
  const handleSave = async () => {
    if (!form.degree || !form.experienceYears || !form.consultationFee) {
      Alert.alert(
        "Required Fields",
        "Please fill in degree, experience, and consultation fee",
      );
      return;
    }
          ...
          {isEditing ? (
            ...
            <View style={{ gap: 16 }}>
              ...
              <Card style={styles.formCard}>
                ...
                <FormField
                  label="Degree *"
                  value={form.degree}
                  onChangeText={(v) => updateForm("degree", v)}
                  theme={theme}
                  placeholder="e.g., Ph.D. in Nutrition"
                />
                <FormField
                  label="Diet Philosophy"
                  value={form.dietPhilosophy}
                  onChangeText={(v) => updateForm("dietPhilosophy", v)}
                  theme={theme}
                  multiline
                />
                <FormField
                ...
                <FormField
                  ...
                  onChangeText={(v) => updateForm("clinicAddress", v)}
                  theme={theme}
                />
              ...
              <Card style={styles.formCard}>
                ...
                >
                  <View style={{ flex: 1 }}>
                    <Txt size={theme.fontSize.md} color={theme.colors.text}>
            ...
            <View style={{ gap: 16 }}>
              ...
              >
                ...
                />
                <Txt size={theme.fontSize.md} color={theme.colors.error}>
                  Logout
                </Txt>
              </TouchableOpacity>
            </View>
